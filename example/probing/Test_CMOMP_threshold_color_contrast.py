# -*- coding: utf-8 -*-
"""
Created on Wed Jul 19 08:57:58 2023

@author: hjammoul

Test CMOMP threshold choice by variation of color contrast
"""
...
img_rgb, se_inf_rgb, se_sup_rgb = generate_img_contrast_difference_effect(height_img=150, img_background_color=(0, 0, 0),target_color = (0, 0, 230),  
                                            num_circles_per_line = 5, circle_radius = 8 )
...
d_over_20 = int(d_conv_pts) / 45
red_cross_mask = CMOMP < 40
