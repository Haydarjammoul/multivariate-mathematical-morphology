# -*- coding: utf-8 -*-
"""
Created on Fri Jul 14 13:41:45 2023

@author: hjammoul
Test SOMP on image with black background for triangle detection
"""
...
img_rgb, se_rgb = generate_color_img(height_img=200, num_shapes=10, shape_min_size=10, shape_max_size=10, mode='CSOMP'
                                     ,img_background_color= (100,0,0), target_color = (0,0,255) )
...
#Apply CSOMP 
O_sup_lab,O_inf_lab,d = extend_convergence_pts(O_sup_lab, O_inf_lab,se_lab)
