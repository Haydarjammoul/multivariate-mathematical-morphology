# -*- coding: utf-8 -*-
"""
Created on Wed Jul 19 10:02:56 2023

@author: hjammoul
Test CMOMP threshold choice by variation of color contrast Blue backround
"""
...
img_rgb, se_inf_rgb, se_sup_rgb = generate_img_contrast_difference_effect(height_img=150, img_background_color=(0, 0, 255),
                                                    target_color = (230, 0, 0),num_circles_per_line = 5, circle_radius = 8 )
