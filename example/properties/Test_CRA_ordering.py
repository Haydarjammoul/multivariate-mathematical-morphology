# -*- coding: utf-8 -*-
"""
Created on Mon Jul 10 16:05:23 2023

@author: hjammoul
Test CRA ordering(by H. Deborah) which is crucizl for idempotence verification
"""
...
eroded = CRA_erosion_rgb(C_img_lab, SE_lab,  O_inf_lab,O_sup_lab) #Erosion on C_img
...
# #2nd Test of Duality
C_img_lab = complemantarity(O_sup_lab, O_inf_lab, img_lab) #complemantary of F
eroded = CRA_erosion_rgb(img_lab, SE_lab,  O_inf_lab,O_sup_lab) #Erosion on img
dilated_value =  CRA_dilation_rgb(C_img_lab, SE_lab,  O_inf_lab,O_sup_lab) #Dilation on C_img
